            ...
            <table className="w-full bg-white rounded-lg shadow">
                  ...
                  {colleges.map(college => (
                    <th key={college.id} className="p-4 text-left">
                      <div className="flex justify-between items-center">
                        ...
                        <button onClick={() => removeCollege(college.id)} className="text-white hover:text-red-300 ml-2">✕</button>
                      </div>
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                ...
                <tr className="border-b bg-gray-50">
                  ...
                  {colleges.map(c => <td key={c.id} className="p-4 text-gray-700">{c.courses.join(', ')}</td>)}
                </tr>
                <tr className="border-b">
